...
public:
    ...
    bool findEmptyGridSlot(int &row, int &col);
      ...
      /*
         The description given for this function by Malik is misleading.
         A better description would be as follows:
         This function finds the first empty slot in the grid and saves its position
         in its arguments and returns true.
         If there is no empty slot, it returns false.
